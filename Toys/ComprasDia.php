...
function FancyTable()
{
    ...
    $this->Cell(30,8,"Proveedor",1,0,'C',true);
    ...
    if(mysqli_num_rows($queryProductosRes)){
        while($rowC=mysqli_fetch_array($queryProductosRes)){
            ...
            $this->Cell(30,8,$rowC[13],'LR',0,'C',"KoSports");
    ...
    $this->Cell(180,0,'','T');
    $this->Ln();
	$this->Cell(120,8,"Historico de compras",'LR',0,'L',"KoSports");
    $queryCompras="SELECT SUM(Total) FROM facturacompra WHERE fechaHora like '$NOWfechaP';";
